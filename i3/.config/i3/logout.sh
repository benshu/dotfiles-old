...
DIALOG_RESULT=$(echo -e 'exit i3\nsuspend\nhibernate\nreboot\npoweroff\nexit' | rofi -dmenu -i -p "SYSTEM" -hide-scrollbar -tokenize -lines 6 -eh 1 -width 25 -location 0 -xoffset 0 -yoffset 0 -padding 20 -disable-history -font "ClearSansMedium 13")
